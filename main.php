...
<div class="centeredDiv">
    ...
    <div class="mainwindow hideable-content" id="pricing_button_content">
        ...
        <span class="highlight">Please enter your contact info: </span><br><br>  
        Phil may follow up with you personally, but your information 
        will never be added to any lists or sold. <br>
         <br>
    ...
    <div class="mainwindow hideable-content" id="home_button_content">
        <div class="contentCol rightCol" style="margin-top:100px;">
            ...
            <span style="display:inline;font-size:40px;line-height:46px;font-weight:bold;text-align:center">engagement sessions<br /> <span style="font-size:14px;line-height:16px;font-weight:normal;text-align:center"><br /> just<br /><br /></span>$49<span style="font-size:14px;line-height:16px;font-weight:normal;text-align:center"><br /><br />for all of 2012<br /><span style="font-size:9px">click for more info</span></span></span>
            </div>
        </div>
        <div class="contentCol leftCol" id="special-details" style="display:none;margin-top:100px;">
            <div style="position:absolute;background-color:#FFF;opacity:0.75;width:300px;height:300px;border-radius:15px;overflow:hidden;"><div class="mainwindowBG"></div></div>
            <div style="position:absolute;width:260px;height:260px;margin:20px;text-align:left;cursor:pointer;"><br />
            <span style="display:inline;font-size:11px;line-height:18px;font-weight:normal;text-align:center">In 2012, Phil moved to the San Francisco Bay Area after photographing weddings on the East Coast for over ten years. To start building a new client base out west, engagement sessions are only $49 for the whole year (they're usually $250). <br /><br />
            It's a private session, approximately 90 minutes, in a location
            of your choice. It includes an online gallery, about 40 4x6" prints, and an 8x10 of your choice.
            There's no commitment: Phil's just looking to meet as many couples as he can.<br /><br />Contact Phil to set up yours!</span>
            </div>
        </div>        
